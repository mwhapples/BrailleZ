...
* Access local files to enable you to create, view edit and store documents on your local computer. The data within the files are kept local (IE. BrailleZ does not transmit these to any server).
