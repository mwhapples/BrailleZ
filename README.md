...
You can download binary builds of BrailleZ from the [download page](https://mwhapples.github.io/BrailleZ/). If your platform does not have a binary build, there is a chance you may be able to build your own copy, see the below instructions for building.
